...
(() => {
  ...
  const logo='<svg viewBox="0 0 40 40" fill="none" aria-hidden="true"><path d="M5 30 12 14 19 22 26 7 36 30 25 35 14 33Z" stroke="currentColor" stroke-width="1.3"/><path d="m19 22 7-15 3 19-4 9-6-13Z" fill="currentColor" opacity=".35"/><path d="m12 14 2 19 15-7 7 4" stroke="currentColor" stroke-width=".7"/></svg>';
  const fallback='<svg viewBox="0 0 360 430" aria-hidden="true"><defs><radialGradient id="jadeCore"><stop stop-color="#c8ead1"/><stop offset=".5" stop-color="#70b293"/><stop offset="1" stop-color="#23624d"/></radialGradient><linearGradient id="stoneShell" x2=".9" y2="1"><stop stop-color="#827d69"/><stop offset=".5" stop-color="#474c40"/><stop offset="1" stop-color="#17281e"/></linearGradient></defs><path d="M100 85Q172 35 239 95L278 192Q290 288 209 342Q114 357 83 273L68 173Z" fill="url(#jadeCore)"/><g class="fallback-shell"><path d="M85 65 208 33 281 102 309 227 257 341 173 378 70 314 41 193Z" fill="url(#stoneShell)"/><path d="m85 65 77 82 46-114 27 177 74 17-105 25 53 89-117-59 33 96-78-126-54-59 91-32-47-96Z" fill="none" stroke="#acbe9a" stroke-opacity=".24" stroke-width="1.3"/><path d="m208 33-46 114 42 105-31 126" fill="none" stroke="#b6e3b7" stroke-width="2"/></g></svg>';
